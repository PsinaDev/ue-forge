...
"""PyInstaller spec for the UE Include Optimizer (standalone)."""
...
a = Analysis(
    [str(project_root / "ue_forge" / "include_optimizer" / "__main__.py")],
